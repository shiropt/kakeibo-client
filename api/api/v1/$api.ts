...
import type { Methods as Methods2 } from './category/_id@string'
import type { Methods as Methods3 } from './money-diary'
import type { Methods as Methods4 } from './money-diary/_id@string'
import type { Methods as Methods5 } from './money-diary/aggregate'
import type { Methods as Methods6 } from './money-diary/month'
import type { Methods as Methods7 } from './money-diary/search'
      ...
      _id: (val1: string) => {
        ...
        return {
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods2['get']['resBody'], BasicHeaders, Methods2['get']['status']>(prefix, prefix1, GET, option).text(),
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods2['get']['resBody'], BasicHeaders, Methods2['get']['status']>(prefix, prefix1, GET, option).text().then(r => r.body),
          patch: (option: { body: Methods2['patch']['reqBody'], config?: T | undefined }) =>
            fetch<Methods2['patch']['resBody'], BasicHeaders, Methods2['patch']['status']>(prefix, prefix1, PATCH, option).text(),
          $patch: (option: { body: Methods2['patch']['reqBody'], config?: T | undefined }) =>
            fetch<Methods2['patch']['resBody'], BasicHeaders, Methods2['patch']['status']>(prefix, prefix1, PATCH, option).text().then(r => r.body),
          delete: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods2['delete']['resBody'], BasicHeaders, Methods2['delete']['status']>(prefix, prefix1, DELETE, option).text(),
          $delete: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods2['delete']['resBody'], BasicHeaders, Methods2['delete']['status']>(prefix, prefix1, DELETE, option).text().then(r => r.body),
          $path: () => `${prefix}${prefix1}`
        }
      },
